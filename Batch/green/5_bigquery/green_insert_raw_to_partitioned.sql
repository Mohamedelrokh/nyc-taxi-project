INSERT INTO `di-malrokh-sandbox-malrokh.taxi_data.green_trips_partitioned` (
    VendorID,
...
FROM `di-malrokh-sandbox-malrokh.taxi_data.green_trips_raw`;  -- Replace with your raw table name
